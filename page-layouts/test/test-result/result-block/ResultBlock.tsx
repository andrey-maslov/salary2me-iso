...
export const ResultBlock: React.FC<ResultBlockProps> = ({title = '', description = '', tableData}) => {
    ...
    let data: any = (desiredResult && localState.isMinimalParams) ? {
        ...
        datasets: [
            {
                label: t('result_page.real_result'),
            ...
            {
                label: t('result_page.desired_result'),
                data: desiredResult,
    ...
    return (
        <>
            ...
            <div className={style.checkbox}>
                <Checkbox
                    label={t('common:result_page.show_minimal')}
                    handle={() => {
