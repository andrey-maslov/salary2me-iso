...
export const LinkedinLogin: React.FC<{isEnabled: boolean}> = ({isEnabled}) => {
    ...
    const linkedinRedirect = `https://www.linkedin.com/oauth/v2/authorization?client_id=${process.env.LINKEDIN_CLIENT_ID}&response_type=code&scope=r_liteprofile%20r_emailaddress&redirect_uri=${LINKEDIN_REDIRECT_URI}/${redirectMode}`
